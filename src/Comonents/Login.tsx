...
const Login = () => {
  ...
  const handelsubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log(err + "catche");
    }
  };
  return (
    <>
      <div className="flex justify-center items-center mt-6 w-[900px] h-[500px]   rounded-lg">
        <div className="w-[450px] h-[500px] bg-[var(--color-card)] rounded-s-xl ">
          <div className="mt-[30px]">
            <h1 className="flex justify-center text-[36px] text-[var(--color-text)] mb-[30px] font-bold">
              Sign In
            </h1>
          </div>
          <div>
            ...
            >
              <div className="relative w-[376px]">
                ...
                <input
                  id="emailOrPhone"
                  className="w-full h-[44px] rounded-md bg-[var(--color-card)] outline-none ring-[0.3px] focus:ring-1 text-[var(--color-text)] placeholder-[var(--color-text-secondary)]  pl-3 pr-10"
                  type="text"
                  name="emailOrPhone"
              ...
              <button
                className="flex items-center justify-center gap-2 bg-[#8B5CF6] rounded-xl p-2 w-[376px] h-[40px] text-[15px] text-[#F8FAFC] hover:bg-[#3B82F6] transtion duration-300"
                type="submit"
              >
                Login
              </button>
              <p className="text-[13px]">
                ...
                <span
                  ...
                  className="underline text-[var(--color-primary)] cursor-pointer hover:text-[var(--color-secondary)]"
                >
                  Create New Account
                </span>
              </p>
        ...
        <div className="relative hidden lg:block w-[450px] h-[500px] bg-[#ECF7FF] rounded-e-xl overflow-hidden">
          <h1 className="p-4 text-[var(--color-secondary)]">logo</h1>
